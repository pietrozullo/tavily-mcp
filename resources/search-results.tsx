...
function TavilyLogo({ size = 28 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Blue arrow — up */}
      <path d="M50 8L62 32H54V52H46V32H38L50 8Z" fill="#4285F4" />
      {/* Red/pink arrow — down-left */}
      <path d="M22 82L18 54L26 58L38 42L44 48L32 64L40 68L22 82Z" fill="#EA4335" opacity="0.75" />
      {/* Yellow/orange arrow — right */}
      <path d="M92 58L64 70V62H44V54H64V46L92 58Z" fill="#FBBC04" />
    </svg>
  );
}
